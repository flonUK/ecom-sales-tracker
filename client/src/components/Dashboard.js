...
const Dashboard = () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const transformedData = {
          ...
          dailyData: data.daily_data || [] // Add daily data for charts
        };
    ...
    return (
      <div className="dashboard-container">
        <div className="dashboard-loading">
          ...
          <p>Loading your business metrics...</p>
  ...
  const hasData = data.totalSales > 0 || platformBreakdown.length > 0;
    ...
    <div className="dashboard-container">
      ...
      {!hasData && !loading && (
        <div className="empty-dashboard">
          ...
          <p>Connect your marketplace accounts to start tracking your sales performance.</p>
          <div className="empty-actions">
            <button className="btn-primary" onClick={() => window.location.href = '/connections'}>
              Connect Platforms
            </button>
      ...
      {/* Charts Section */}
      {hasData && data.dailyData.length > 0 && (
                ...
                platformBreakdown.map((platform, index) => (
                  <div key={index} className="platform-metric">
                    <div className="platform-info">
                      <div className={`platform-icon ${platform.platform.toLowerCase()}`} style={{ backgroundColor: getPlatformColor(platform.platform) }}>
      ...
      <div className="quick-actions">
        <button className="action-btn primary" onClick={() => window.location.href = '/analytics'}>
          <span className="action-icon">📊</span>
          View Detailed Analytics
        </button>
        <button className="action-btn" onClick={() => window.location.href = '/sales'}>
          <span className="action-icon">📦</span>
          View Sales Data
        </button>
        <button className="action-btn" onClick={() => window.location.href = '/connections'}>
          <span className="action-icon">🔗</span>
          Manage Connections
        </button>
