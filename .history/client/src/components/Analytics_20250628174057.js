      ...
      <div className="analytics-metrics">
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <div className="metric-period">vs last period</div>
          </div>
        </div>
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <div className="metric-period">+0.5% vs last period</div>
          </div>
        </div>
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <div className="metric-period">+12% vs last period</div>
          </div>
        </div>
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <div className="metric-period">+2.1% vs last period</div>
          </div>
        </div>
      </div>
