      ...
      <div className="customer-metrics-grid">
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <div className="metric-period">3+ orders</div>
          </div>
        </div>
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <div className="metric-period">£100+ spent</div>
          </div>
        </div>
          ...
          <div className="metric-content">
            ...
            <div className="metric-value">
              {data.summary.totalCustomers > 0 
                ? Math.round((data.summary.frequentBuyers / data.summary.totalCustomers) * 100)
                : 0}%
            </div>
