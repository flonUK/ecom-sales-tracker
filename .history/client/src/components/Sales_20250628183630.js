        ...
        <div className="summary-card">
          ...
          <div className="summary-content">
            ...
            <div className="summary-value">
              {formatCurrency(Array.isArray(sales) ? sales.reduce((sum, sale) => sum + (sale.revenue || 0), 0) : 0)}
            </div>
          </div>
        </div>
          ...
          <div className="summary-content">
            ...
            <div className="summary-value">
              {Array.isArray(sales) && sales.length > 0 
                ? formatCurrency(sales.reduce((sum, sale) => sum + (sale.revenue || 0), 0) / sales.length)
                : formatCurrency(0)
              }
            </div>
          </div>
              ...
              <div key={index} className="table-row">
                <div className="table-cell">
                  <div className="date-info">
                    <span className="date">{formatDate(sale.date)}</span>
                  </div>
                </div>
                ...
                <div className="table-cell">
                  <div className="order-id">{sale.orderId}</div>
                </div>
                
                <div className="table-cell">
                  <div className="revenue">{formatCurrency(sale.revenue)}</div>
                </div>
