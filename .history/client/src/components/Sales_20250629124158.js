          ...
          <>
            <div className="sales-table">
              <div className="table-header-row">
                <div className="table-cell header sortable" onClick={() => handleSort('sale_date')}>
                  Date {getSortIndicator('sale_date')}
                </div>
                <div className="table-cell header sortable" onClick={() => handleSort('platform')}>
                  Platform {getSortIndicator('platform')}
                </div>
                <div className="table-cell header sortable" onClick={() => handleSort('item_title')}>
                  Item {getSortIndicator('item_title')}
                </div>
                <div className="table-cell header sortable" onClick={() => handleSort('order_id')}>
                  Order ID {getSortIndicator('order_id')}
                </div>
                <div className="table-cell header sortable" onClick={() => handleSort('quantity')}>
                  Qty {getSortIndicator('quantity')}
                </div>
                <div className="table-cell header sortable" onClick={() => handleSort('price')}>
                  Price {getSortIndicator('price')}
                </div>
                <div className="table-cell header sortable" onClick={() => handleSort('price')}>
                  Revenue {getSortIndicator('price')}
                </div>
                <div className="table-cell header sortable" onClick={() => handleSort('status')}>
                  Status {getSortIndicator('status')}
                </div>
              </div>

              {currentSales.map((sale, index) => (
                <div key={`${sale.id || sale.order_id}-${sale.item_id}-${index}`} className="table-row">
                  ...
                  <div className="table-cell">
                    <div className="quantity">{sale.quantity || 1}</div>
                  </div>
                  <div className="table-cell">
                    <div className="price">{formatCurrency(sale.price)}</div>
                  </div>
                  <div className="table-cell">
                    <div className="revenue">{formatCurrency(sale.price * (sale.quantity || 1))}</div>
                  </div>
                  <div className="table-cell">
                    <div 
